...
function cargar() {
    ...
    $.ajax({
        ...
        success: function (data) {
            var objUser = data.d;
            $('#nombres').text(objUser.Nombre + " " + objUser.Apellido);
            $("#emails").text(objUser.Email);
            $('#phones').text(objUser.Telefono);
            $('#cell').text(objUser.Celular);
            $("#usernames").text(objUser.Username);
