                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="pull-right box-tools">
                            <a class="btn btn-primary btn-sm" href="javascript:subirFoto()" data-toggle="tooltip" title="Subir Foto de Perfil"><i class="fa fa-camera-retro" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    <div class="box-body box-profile">
                        <img id="imagenp" class="profile-user-img img-responsive img-circle" src="" alt="foto-Perfil" />
                        <h3 class="profile-username text-center" id="nombrep"></h3>
                        <p class="text-muted text-center" id="usernamep"></p>
