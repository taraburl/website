            ...
            <asp:GridView runat="server" ID="GridView1"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actualizar">
                        <ItemTemplate>
                            <a class="btn btn-block btn-info btn-circle actualizarFilaCategoria<%# Eval("id") %>" href="javascript:actualizarCategoria(<%# Eval("id")%>)">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Eliminar">
                        <ItemTemplate>
                            <a class="btn btn-block btn-danger btn-circle eliminarFilaCategoria<%# Eval("id")%>" href="javascript:eliminarCategoria(<%# Eval("id") %>)">
