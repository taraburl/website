            ...
            <asp:GridView runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actualizar">
                        <ItemTemplate>
                            <a class="btn btn-block btn-info btn-circle actualizarFilaProducto<%# Eval("IdProducto") %>" href="javascript:actualizarProducto(<%# Eval("IdProducto")%>)">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Eliminar">
                        <ItemTemplate>
                            <a class="btn btn-block btn-danger btn-circle eliminarFilaProducto<%# Eval("IdProducto")%>" href="javascript:eliminarProducto(<%# Eval("IdProducto") %>)">
                                <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Subir Fotos">
                        <ItemTemplate>
                            <a class="btn btn-block btn-warning btn-circle" href="SubirImagenProducto.aspx?ID=<%# Eval("IdProducto")%>">
