...
public partial class admin_eventos_SubirBannerEvento : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        imgPrincipal.ImageUrl = "~/images/publicidad/" + Request.QueryString["ID"] + ".jpg";
    }
    ...
    protected void btnGuardarImagen_Click(object sender, EventArgs e)
    {
        ...
        uploader.SaveAs(pathSitio + "images/publicidad/" + id + ".jpg");
        Response.Redirect("eventos.aspx");
    }
}